...
matrix.geno<-read.table("03_matrices/matrix.genetic.txt",header=TRUE)
names.matrix<-read.table("03_matrices/loci.matrix.txt",header=F)
...
#upload strata
strata<-read.table("01_info_file/strata.__NB__.txt",header=F)
